                    ...
                    new gridjs.Grid({
                      ...
                      search: true,
                         data : [ 
                                    ...
                                    ?>
                                        ['<a href="{{ route('show.file.contacts', ['id' => $file->id]) }}"><?=$file->file_name;?></a>','<?=$file->whats_app_msgs_pending_count ?? '--';?>','<?=$file->whats_app_msgs_sent_count ?? '--';?>','<?=$file->whats_app_msgs_failed_count ?? '--';?>','<?=$file->whats_app_msgs_all_count ?? '--';?>','<?=$file=$statusButton;?>'],<?php } ?>
                                ]
    ...
    dropdownItems.forEach(function(item) {
        item.addEventListener('click', function(event) {
            ...
            if (selectedRole !== "") {
                ...
                window.location.href = "{{ route('show.users') }}?role=" + selectedRole;
            }
        });
    });
        ...
        $(document).on('click', '.edit-birthday', function() {
            ...
            var _url = "{{ route('show.getUserProfile')}}"; // Example path, replace with your actual path
