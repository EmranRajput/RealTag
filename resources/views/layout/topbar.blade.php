    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <img class="sidebar-img" src="{{ userLogin()->getProfilepic(1) }}" alt="" style="width: 50px; height: 50px; border-radius: 50%;border: 2px solid #fff;">
                @else
                <img class="sidebar-img" src="{{ asset('assets/images/default.png') }}" alt="" style="width: 50px; height: 50px; border-radius: 50%;border: 2px solid #fff;">
                @endif
            <div class="admin-action-info"> <span> {{ logRolePrint() }}</span>
                <h5 class="white-space-no-wrap">{!! logName() !!}</h5>
            </div>
                </button>
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    <div class="p-3 border-bottom">
                        <h6 class="mb-0">{!! logName() !!}</h6>
                        <p class="mb-0 font-size-11 text-muted"></p>
                    </div>
                    <a class="dropdown-item" href="{{route('app.profile')}}"><i
                    ...
                    <form id="logout-form1" action="{{ route('app.logout') }}" method="GET" style="display: none;">
                        @csrf
