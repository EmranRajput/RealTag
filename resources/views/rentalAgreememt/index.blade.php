                        ...
                        <div class="col-sm-3  mb-4">
                         ...
                         <div class="col-sm-3 mb-4">
                            ...
                            <div class="col-sm-3 mb-4">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="rental_amount form-control" name="address" placeholder="Search Address" value="{{ request('address') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <a class="btn btn-danger  mb-2" href="{{ route('agent.rental.agreements') }}"> Reset Filter</a>
                            <a href="" class="create-new">
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="frm_create" method="POST" action="{{ route('agent.rental.agreement.create.update') }}"
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select class="form-control select-tenant" id="exampleSelect" name="tenant">
                                                ...
                                                <option value="{{ $tanent->id }}">{{  $tanent->identity_number }}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select class="form-control select-landlord" id="exampleSelect"
                                                ...
                                                <option value="">Select Landlord</option>
                                                @foreach($landlords as $landlord)
                                                <option value="{{ $landlord->id }}" >{{  $landlord->identity_number }}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select class="form-control" id="exampleSelect" name="agreement">
                                                ...
                                                @if(!empty($agreementss))
                                                    @foreach($agreementss as $agreement)
                        ...
                        <form id="frm" method="POST" action="{{ route('invoices.create.update') }}"
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-12 " id="dynamic-rows-container">
                                    @if(!empty($item_lists) && is_array($item_lists))
...
<script>
            ...
            var _url = "{{ route('agent.rental.agreement.show')}}"; // Example path, replace with your actual path
