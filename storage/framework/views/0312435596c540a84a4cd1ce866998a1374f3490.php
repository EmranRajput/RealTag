            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="frm_create" method="POST" action="<?php echo e(route('agreements.create.update')); ?>" class="cls-crud-simple-save" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
<div class="modal fade edit-order" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="frm_edit" method="POST" action="<?php echo e(route('agreements.create.update')); ?>" class="cls-crud-simple-save" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label" for="AddOrder-Billing-Name">Title</label>
                                    <input type="text" class="form-control edit_title" name="title"   value="<?php echo e(@$getData->title ??  old('title')); ?>"  placeholder="Agreement Title"
                                        id="AddOrder-Billing-Name">
                                </div>
                            </div>
                            ...
                            },
                            {
                                ...
                                formatter: (function (cell) {
                                  return gridjs.html(`<div class="d-flex gap-3">${cell}</div>`);
                                    ...
                                    //<?php echo e(route('user.agreements.edit')); ?>

                                    //<?php echo e(route('agreements.delete')); ?>
...
// status active/deactive
            $(document).on('change', '.switch-active', function() {
                ...
                var _url = "<?php echo e(route('agreement.active.deactive')); ?>";
        ...
        $(document).on('click', '.del-btn', function() {    
            // $(".del-btn").click(function() {
                ...
                var _url = "<?php echo e(route('agreements.delete')); ?>";
...
<?php echo $__env->make('layout.master-inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp\www\realtagportal\resources\views/agreements/index.blade.php ENDPATH**/ ?>