    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="page-title-box align-self-center d-none d-md-block">
                <h4 class="page-title mb-0"><?php echo $__env->yieldContent('page-title'); ?></h4>
            </div>
            <!-- end page title -->
        ...
        <div class="d-flex">
            ...
            <!--        aria-expanded="false">-->
            <!--        <img class="header-lang-img" src="<?php echo e(URL::asset('../build/images/flags/us.jpg')); ?>"-->
            ...
            <!--            <img src="<?php echo e(URL::asset('../build/images/flags/germany.jpg')); ?>" alt="user-image" class="me-1"-->
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item user text-start d-flex align-items-center"
                    ...
                    aria-expanded="false">
                <?php if(isset(userLogin()->profile_photo)): ?>

                <img class="sidebar-img" src="<?php echo e(userLogin()->getProfilepic(1)); ?>" alt="" style="width: 50px; height: 50px; border-radius: 50%;border: 2px solid #fff;">
                <?php else: ?>
                <img class="sidebar-img" src="<?php echo e(asset('assets/images/default.png')); ?>" alt="" style="width: 50px; height: 50px; border-radius: 50%;border: 2px solid #fff;">
                <?php endif; ?>
            <div class="admin-action-info"> <span> <?php echo e(logRolePrint()); ?></span>
                <h5 class="white-space-no-wrap"><?php echo logName(); ?></h5>
            </div>
                </button>
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    <div class="p-3 border-bottom">
                        <h6 class="mb-0"><?php echo logName(); ?></h6>
                        <p class="mb-0 font-size-11 text-muted"></p>
                    </div>
                    <a class="dropdown-item" href="<?php echo e(route('app.profile')); ?>"><i
                   ...
                   <a class="dropdown-item" href="javascript:void();"
                    ...
                    <form id="logout-form" action="<?php echo e(route('app.logout')); ?>" method="GET" style="display: none;">
                        <?php echo csrf_field(); ?>
                    </form>
                </div>
            </div>
...
<?php /**PATH E:\wamp\www\realtagportal\resources\views/layout/topbar1.blade.php ENDPATH**/ ?>