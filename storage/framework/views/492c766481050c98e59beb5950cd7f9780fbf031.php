...
<?php $__env->startSection('css'); ?>
    ...
    <!-- datepicker css -->
    <link rel="stylesheet" href="<?php echo e(URL::asset('build/libs/flatpickr/flatpickr.min.css')); ?>">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                    <h5 class="white-space-no-wrap"><?php echo logName(); ?></h5>
                        <form id="frmProfile" method="POST" action="<?php echo $urlSave; ?>" class="cls-crud-simple-save"
                                    ...
                                    <div class="form-group">
                                        <div class="profile-img ">
                                            ...
                                            <label for="file-1" id="file-1-preview">
                                                <?php if(userLogin()->profile_photo !== null): ?>
                                                <img src="<?php echo e(userLogin()->getProfilepic(1)); ?>"
                                                    alt="<?php echo e(userLogin()->name); ?>" class="profile-img-two" style="width: 200px; height: 200px; border-radius:50%; margin-top:50%; border: 2px solid #fff;">
                                                <?php else: ?>
                                                <img src=" <?php echo e(asset('assets/images/default.png')); ?> "
                                                    alt="<?php echo e(userLogin()->name); ?>" class="profile-img-two" style="width: 200px; height: 200px; border-radius:50%; margin-top:50%; margin-left:100%; border: 2px solid #fff;">
                                                <?php endif; ?>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" class="form-control" id="fname" placeholder="First Name"
                                                name="first_name" value="<?php echo e($fname); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="lname" placeholder="Last Name"
                                                name="last_name" value="<?php echo e($lname); ?>" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="datepicker" class="datepicker form-control"
                                                ...
                                                value="<?php echo e(frDate(userLogin()->birth_date)); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6  mt-3">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control show-tick select2" name="gender">
                                            <?php echo makeDropdown(siteConfig('gender'),userLogin()->gender); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class="form-control" placeholder="Phone"
                                                name="phone_number" value="<?php echo e(userLogin()->phone_number); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6  mt-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="email" class="form-control" placeholder="Enter Your Email"
                                                name="email" value="<?php echo e(logEmail()); ?>" required disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6  mt-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class="form-control" placeholder="IC Number"
                                                name="ic_number" value="<?php echo e(userLogin()->ic_number); ?>"
                                                required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Address" name="address"
                                                value="<?php echo e(userLogin()->address); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 mt-3">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line d-flex">
                                            <div class="input-group-append">
                                                ...
                                                <!--    <input type="checkbox" <?php echo e(userLogin()->reminder_email_toggle==1 ? 'checked' : ''); ?> id="reminder_toggle">-->
                                                <!--    <span class="slider round"></span>-->
                                                <!--</label>-->

                                            <input type="checkbox" class="switch-active" <?php echo e(userLogin()->reminder_email_toggle==1 ? 'checked' : ''); ?> id="reminder_toggle"   switch="none"  />
...
<!--//-->
                                    ...
                                    <!--//-->
                                            ...
                                            <input type="hidden" name="reminder" id="reminder_input" value="<?php echo e(userLogin()->reminder_email_toggle==1 ? '1' : '0'); ?>">
                                        </div>
                                    </div>
                             </div>
                             <div class="col-sm-6 mt-3 ml-3">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line d-flex">
                                            <div class="input-group-append">
                                                <!--<label class="switch">-->
                                                <!--    <input type="checkbox" id="reminder_toggle1" <?php echo e(userLogin()->birthday_reminder_toggle==1 ? 'checked' : ''); ?>>-->
                                                <!--    <span class="slider round"></span>-->
                                                <!--</label>-->
                                            <input type="checkbox" class="switch-active" <?php echo e(userLogin()->birthday_reminder_toggle==1 ? 'checked' : ''); ?> id="reminder_toggle1"   switch="none"  />
                                            <label for="reminder_toggle1"  data-on-label="on" data-off-label="off"></label>
                                            </div>
                                            <!-- Hidden input field to store the toggle value -->
                                            <input type="hidden" name="reminder_birthday" id="reminder_input1" value="<?php echo e(userLogin()->birthday_reminder_toggle==1 ? '1' : '0'); ?>">
                                        </div>
                                    </div>
                             </div>
                                <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="frmPassword1" method="POST" action="<?php echo e(route('Invoice-setting')); ?>" class="cls-crud-simple-save" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <input name="inv_set_id" value="<?php echo e((isset($inv_setting->id)) ? $inv_setting->id : 0); ?>" type="hidden">
                            <input name="agent_id" value="<?php echo e(userLogin()->id); ?>" type="hidden">
                            <!--//-->
                             <div class="row clearfix">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                           <input type="text" id="company_name" class="form-control"  value="<?php echo e((isset($inv_setting->company_name)) ? $inv_setting->company_name : ''); ?>" name="company_name"
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                             <input type="text" id="company_address" value="<?php echo e((isset($inv_setting->company_address)) ? $inv_setting->company_address : ''); ?>" class="form-control" name="company_address"
                                ...
                                <div class="col-sm-6 mt-3">
                                    ...
                                    <div class="form-line d-flex">
                                    <input type="number" id="Company_tel" class="form-control" value="<?php echo e((isset($inv_setting->contact)) ? $inv_setting->contact : ''); ?>" name="contact"
                                ...
                                <div class="col-sm-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                             <input type="text" value="<?php echo e((isset($inv_setting->company_fax)) ? $inv_setting->company_fax : ''); ?>" id="Company_fax" class="form-control" name="company_fax"
                                ...
                                <div class="col-sm-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" value="<?php echo e((isset($inv_setting->sst_id)) ? $inv_setting->sst_id : ''); ?>" id="sst" class="form-control" name="sst_id"
                                ...
                                <div class="col-sm-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" value="<?php echo e((isset($inv_setting->service_tax)) ? $inv_setting->service_tax : ''); ?>" id="service_tax" class="form-control" step="0.01" name="service_tax"
                                 ...
                                 <div class="col-sm-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" value="<?php echo e((isset($inv_setting->description)) ? $inv_setting->description : ''); ?>" id="description" class="form-control" name="description"
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="frmPassword" method="POST" action="<?php echo $paswordChange; ?>" 
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp\www\realtagportal\resources\views/profile/profile.blade.php ENDPATH**/ ?>