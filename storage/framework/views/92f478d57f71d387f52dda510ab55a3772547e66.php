                    ...
                    <div class="card-body">
                        <div class="position-relative">
                            <div class="modal-button mt-2">
                                    ...
                                    <a href="<?php echo e(route('agent.tenant.downloadContact')); ?>" class="create-new">
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="frm_create" method="POST" action="<?php echo e(route('agent.tenants.create.update')); ?>" class="cls-crud-simple-save" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<div class="modal fade edit-order1" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
    ...
    <?php $__env->startSection('scripts'); ?>
        ...
        //view
                ...
                var _url = "<?php echo e(route('agent.tenants.active.update.deactive')); ?>";
...
//birthday notification status
                ...
                $(document).on('change', '.switch-activeB', function () {
                    ...
                    var _url = "<?php echo e(route('agent.landlord.birthday.notification')); ?>";
                    var csrfToken = "<?php echo e(csrf_token()); ?>"; // Retrieve CSRF token
        ...
        $(document).on('click', '.del-btn', function() {    
            // $(".del-btn").click(function() {
                ...
                var _url = "<?php echo e(route('agent.tenants.delete')); ?>";
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp\www\realtagportal\resources\views/newTenant/index.blade.php ENDPATH**/ ?>