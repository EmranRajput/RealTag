            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="email_frm1" method="POST" action="<?php echo $urlSave; ?>" class="cls-crud-simple-save needs-validation" novalidate enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp\www\realtagportal\resources\views/agents/add-form.blade.php ENDPATH**/ ?>