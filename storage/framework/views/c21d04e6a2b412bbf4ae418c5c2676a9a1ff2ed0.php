            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="frm_create" method="POST" action="<?php echo e(route('rental.template.create.update')); ?>" class="cls-crud-simple-save" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<div class="modal fade edit-order" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="edit_frm" method="POST" action="<?php echo e(route('rental.template.create.update')); ?>" class="cls-crud-simple-save" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
<!-- Edit Model End-->
    ...
    <?php $__env->startSection('scripts'); ?>
        ...
        //edit birthday
            ...
            $(document).on('change', '.switch-active', function() {
                ...
                var _url = "<?php echo e(route('rental.template.active.update.deactive')); ?>";
        ...
        $(document).on('click', '.deleteBirthdays', function() {    
            // $(".del-btn").click(function() {
                ...
                var _url = "<?php echo e(route('rental.template.delete')); ?>";
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo e(route('rental.template.set.default')); ?>",
        data: {
            id: data.value,
...
<?php echo $__env->make('layout.master-inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp\www\realtagportal\resources\views/rental/index.blade.php ENDPATH**/ ?>