                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="modal-body">
                         ...
                         <form id="frm_create" method="POST" action="<?php echo e(route('invoices.create.update')); ?>"
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" id="service_tax" class="form-control" value="<?php echo e($invSetting->service_tax); ?>"  name="service_tax"
                                               readonly required>
                                        </div>
...
<div class="modal fade edit-order" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="frm_edit" method="POST" action="<?php echo e(route('invoices.create.update')); ?>"
                            class="cls-crud-simple-save" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" value="<?php echo e(@$getData->id); ?>" name="id" id="edit_id" class="edit_id">
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <label for="first_name">Name :<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="name" class="form-control name" name="name"
                                                value="<?php echo e(@$getData->name ?? old('name')); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" id="service_tax" class="form-control service_tax" name="service_tax"
                                                value="<?php echo e(@$getData->service_tax ?? old('service_tax')); ?>" readonly required>
                                        </div>
                                        <p class="text-danger" id="dateError"></p>
                                    </div>
                                </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                $(document).on('click','.invoice-status',function(event) {
                    ...
                    var _url = "<?php echo e(route('invoices.change.status')); ?>";
    ...
    $(this).closest('.dynamic-row-edit').remove();
        ...
        //end edit invioce
            ...
            // $(".del-btn").click(function() {
                ...
                var _url = "<?php echo e(route('invoices.delete')); ?>";
                var csrfToken = "<?php echo e(csrf_token()); ?>";
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp\www\realtagportal\resources\views/invoices/index.blade.php ENDPATH**/ ?>