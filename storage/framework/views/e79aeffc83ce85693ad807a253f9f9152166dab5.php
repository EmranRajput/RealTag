    ...
    <div data-simplebar class="sidebar-menu-scroll">
        ...
        <div id="sidebar-menu">
            ...
            if (isAdmin()) {
                ...
                $menuArr[] = [
                    'icon' => '<i class="bx bx-file icon nav-icon"></i>',
                    'route' => 'user.agreements',
                    'title' => 'Agreements',
                ];
                $menuArr[] = [
                    'icon' => '<i class="bx bx-cake icon nav-icon"></i>',
...
<!-- Left Sidebar End --><?php /**PATH E:\wamp\www\realtagportal\resources\views/layout/sidebar.blade.php ENDPATH**/ ?>