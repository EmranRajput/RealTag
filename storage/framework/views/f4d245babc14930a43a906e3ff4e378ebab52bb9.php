...
<?php $__env->startSection('body'); ?>
                            ...
                            <div class="col-4">
                                <div class="text-center">
                                    ...
                                    <p class="mb-1 text-muted font-size-14">Completed <span
                                            class="badge bg-success-subtle text-success">+40%</span></p>
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="text-center">
                                    ...
                                    <p class="mb-1 text-muted font-size-14">Pending <span
                                            class="badge bg-danger-subtle text-danger">-10%</span></p>
                            ...
                            <div class="col-4">
                                <div class="text-center">
                                    ...
                                    <p class="mb-1 text-muted font-size-14">Cancel <span
                                            class="badge bg-success-subtle text-success">+20%</span></p>
                                        ...
                                        <td>
                                            <div class="avatar">
                                                <div
                                                    ...
                                                    <img src="<?php echo e(URL::asset('build/images/product/img-1.png')); ?>"
                                                        class="img-fluid" alt="">
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="avatar">
                                                <div
                                                    ...
                                                    <img src="<?php echo e(URL::asset('build/images/product/img-2.png')); ?>"
                                                        class="img-fluid" alt="">
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="avatar">
                                                <div
                                                    ...
                                                    <img src="<?php echo e(URL::asset('build/images/product/img-3.png')); ?>"
                                                        class="img-fluid" alt="">
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="avatar">
                                                <div
                                                    class="product-img avatar-title img-thumbnail bg-success-subtle border-0">
                                                    <img src="<?php echo e(URL::asset('build/images/product/img-5.png')); ?>"
                                                        class="img-fluid" alt="">
                                                </div>
                                            </div>
                                        </td>
    ...
    <?php $__env->startSection('scripts'); ?>
        ...
        <script src="<?php echo e(URL::asset('build/js/pages/dashboard-sales.init.js')); ?>"></script>

        <!-- App js -->
        <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
    <?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp\www\realtagportal\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>